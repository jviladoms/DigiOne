...
private slots:
    ...
    void mycall_changed(QString mc) { m_txmycall = mc.toUpper(); }
    void urcall_changed(QString uc) { m_txurcall = uc.toUpper(); }
    void rptr1_changed(QString r1) { m_txrptr1 = r1.toUpper(); }
    void rptr2_changed(QString r2) { m_txrptr2 = r2.toUpper(); }
